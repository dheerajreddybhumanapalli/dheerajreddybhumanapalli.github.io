...
- Docs live in `docs/` (`README.md` index, `architecture.md`, `blog-authoring.md`, `deployment.md`). Check the relevant doc before changing build scripts, routing, or deploy flow.
